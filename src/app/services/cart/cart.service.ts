...
export class CartService {
  ...
  alertClearCart(index, items, data, order?) {
    this.global.showAlert(
      order
        ? "¿Le gustaría restablecer su carrito antes de volver a realizar un pedido en este restaurante?"
        : "Su carrito contiene artículos de un restaurante diferente. ¿Quieres restablecer tu carrito antes de navegar por el restaurante??",
      "Artículos que ya están en el carrito",
      [
        {
          text: "No",
          role: "cancel",
